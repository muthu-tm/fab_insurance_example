...
func pkcs7Padding(src []byte) []byte {
	...
	// fmt.Println("Encrypt: padding source string value- ", string(src))
	// fmt.Println("Encrypt: length of source - ", len(src))
	// fmt.Println("Encrypt: padding - ", padding)
...
func pkcs7UnPadding(src []byte) ([]byte, error) {
	...
	// fmt.Println("Decrypt: unpadding source string value - ", string(src))
	// fmt.Println("Decrypt: unpadding - ", unpadding)
	// fmt.Println("Decrypt: length of source - ", length)
